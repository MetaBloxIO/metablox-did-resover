...
export type EthrDidRegistryDeployment = {
   ...
   * not set. Example: `did:metablox:<0xHexChainId>:0x...`
   */
   ...
   * This is used to construct DIDs on this network: `did:metablox:<name>:0x...`.
  ...
  rpcUrl?: string
  /**
   * Contracts prior to metablox-did-registry@0.0.3 track nonces differently for meta-transactions
   *
   * @see https://github.com/decentralized-identity/metablox-did-resolver/pull/164
   */
  legacyNonce?: boolean
